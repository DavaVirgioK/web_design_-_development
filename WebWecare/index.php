...
<body>
 ...
 <span class="d-block p-1 bg-dark ">
    ...
    <div class="nav pt-3">
      ...
      <li class="nav-item">
        <b><a class="nav-link text-white active h5" href="about2.html">About Us</a></b>
      </li>
      <li class="nav-item">
        <b><a class="nav-link text-white active h5" href="login.php">Log In</a></b>
      </li>
     </div>
    </ul>
...
<div class="container3 text-biru-tua-weCare ">
    ...
    <div class="container-fluid banner p-5">
      <div class="container text-center">
        ...
        <a href="Login.php"> <button type="button"  class="btn btn-biru-weCare btn-lg">Lapor Disini</button></a>
      </div>
    </div>
</div>
