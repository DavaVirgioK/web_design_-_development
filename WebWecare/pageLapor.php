 ...
 <span class="d-block p-1 bg-dark ">
  ...
  <div class="container-fluid banner my-5 ">
      <div class="container text-center">
        <h3 class="display-4 font-weight-bold">Form Laporan Kekerasan Seksual<hr></h4>
      </div>
    </div>

      
    <form class="container py-3 pb-5" method="post" action="lapor.php">
      <div class="form-row">
        <div class="form-group col-md-6">
          <label>Nama depan</label>
          <input type="text" class="form-control" name="namadepan" placeholder=" ">
        </div>
        <div class="form-group col-md-6">
          <label for="inputPassword4">Belakang</label>
          <input type="text" class="form-control" name="namabelakang" placeholder=" ">
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-12">
          ...
          <input type="textarea" class="form-control datatext form-control-lg" name="kejadian" placeholder="">
        </div>
      </div>
      
      <br>
      <button class="btn btn-biru-weCare btn-lg" onclick="myFunction()">Lapor</button>

      <script>
      function myFunction() {
        alert("Berhasil\nLaporan anda berhasil dirkirim!!");
      }
      </script>
    </form>
